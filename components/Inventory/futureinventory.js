...
const FutureInventory = () => {
    ...
    const onAddFutureInventory = async (data) => {
        const body = {
            ...
            cropDetailId: "E7F57484-6157-EC11-A355-AC12030DA196"
        }
        try {
            await createFutureInventoryAction(body, token, dispatch);
        } catch {
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="form-group">
                                ...
                                <select {...register('crop', { required: true })}
                                    className="dashbaord-category-select"
                                ...
                                >
                                    ...
                                    <option>Potati</option>


                                </select>
                                {errors["crop"] && <span className="errorMessage">Please select crop </span>}
                            </div>
                        </div>
                    </div>
                    
                    <div className="add-listings-btn">
                        <button type="submit" onClick={handleSubmit(onAddFutureInventory)}>Add Future Inventory</button>
                    </div>
